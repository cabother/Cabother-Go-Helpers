...
type mockConstructorTestingTNewMySQLServiceInterface interface {
	mock.TestingT
	Cleanup(func())
}

// NewMySQLServiceInterface creates a new instance of MySQLServiceInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMySQLServiceInterface(t mockConstructorTestingTNewMySQLServiceInterface) *MySQLServiceInterface {
	mock := &MySQLServiceInterface{}
	mock.Mock.Test(t)
