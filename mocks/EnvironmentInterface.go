...
type mockConstructorTestingTNewEnvironmentInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewEnvironmentInterface(t mockConstructorTestingTNewEnvironmentInterface) *EnvironmentInterface {
